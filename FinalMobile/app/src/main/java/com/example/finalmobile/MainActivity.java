...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private int c3, c3black, d3, d3black, e3, f3, f3black, g3, g3black, a3, a3black, b3, 
            c4, c4black, d4, d4black, e4, f4, f4black, g4, g4black, a4, a4black, b4, 
            c5, c5black, d5, d5black, e5, f5, f5black, g5, g5black, a5, a5black, b5,
            c6, c6black, d6, d6black, e6, f6, f6black, g6, g6black, a6, a6black, b6,
            c7, c7black, d7, d7black, e7, f7, f7black, g7, g7black, a7, a7black, b7;
    
    private HorizontalScrollView scrollView;

    private Button buttonC3, buttonC3black, buttonD3, buttonD3black, buttonE3, buttonF3, buttonF3black,
            buttonG3, buttonG3black, buttonA3, buttonA3black, buttonB3, buttonC4, buttonC4black, buttonD4,
            buttonD4black, buttonE4, buttonF4, buttonF4black, buttonG4, buttonG4black, buttonA4, 
            buttonA4black, buttonB4, buttonC5, buttonC5black, buttonD5, buttonD5black, buttonE5, buttonF5, 
            buttonF5black, buttonG5, buttonG5black, buttonA5, buttonA5black, buttonB5, buttonC6, buttonC6black, buttonD6,
            buttonD6black, buttonE6, buttonF6, buttonF6black, buttonG6, buttonG6black, buttonA6,
            buttonA6black, buttonB6, buttonC7, buttonC7black, buttonD7, buttonD7black, buttonE7,
            buttonF7, buttonF7black, buttonG7, buttonG7black, buttonA7, buttonA7black, buttonB7;

    // variables for TextViews

    private TextView tc3, td3, te3, tf3, tg3, ta3, tb3, tc4, td4, te4, tf4, tg4, ta4, tb4, tc5, td5,
     te5, tf5, tg5, ta5, tb5, tc6, td6, te6, tf6, tg6, ta6, tb6, tc7, td7, te7, tf7, tg7, ta7, tb7;
